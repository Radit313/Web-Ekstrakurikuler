    ...
    <form method="post" action="">
        <table>
            <tr>
                ...
                <td><input type="text" id="username" name="username" value="<?= htmlspecialchars($saved_user); ?>" required></td>
            </tr>
            <tr>
                <td><label for="password">Password:</label></td>
                <td><input type="password" id="password" name="password" value="<?= htmlspecialchars($saved_pass); ?>" required></td>
            </tr>
            <tr>
                <td></td>
