    ...
    <form method="post" action="">
        <table>
            <tr>
                ...
                <td><input type="text" id="nis" name="nis" placeholder="Masukkan NIS kamu" value="<?php echo htmlspecialchars($saved_nis); ?>" autocomplete="off" required></td>
            </tr>
            <tr>
                <td><label for="nama_siswa">Nama:</label></td>
                <td><input type="text" id="nama_siswa" name="nama_siswa" placeholder="Masukkan nama kamu" value="<?php echo htmlspecialchars($saved_nama); ?>" autocomplete="off" required></td>
            </tr>
            <tr>
                <td></td>
